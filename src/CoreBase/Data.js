...
export const Data2 = {
    data: {
        ...
        similarity_documents:[
            {
                name: "1451020047_NGUYENHOANGDUONG.pdf",
                value: 62,
                similarity_sentences: [
                    "CƠ SỞ LÝ THUYẾT VÀ CÔNG NGHỆ SỬ DỤNG \n \n2.1 Giới thiệu về ngành công nghệ thông tin  \nCông nghệ thông tin (CNTT) là lĩnh vực nghiên cứu và ứng dụng công nghệ để quản lý \nvà xử lý thông tin.",
                    "Đặt vấn đề: \n Trong ngành xây dựng, quản lý vật liệu là một trong những yếu tố cốt lõi quyết định \nđến sự thành công của một dự án.",
                    "Quản lý vật liệu không chỉ đòi hỏi sự cẩn trọng và tổ \nchức chặt chẽ mà còn đề xuất tính hiệu quả và linh hoạt.",
                    "Đối mặt với sự phức tạp và đa \ndạng của các vật liệu, cùng với sự động thái và không chắc chắn của thị trường, việc \nứng dụng công nghệ thông tin trong quản lý vật liệu xây dựng trở nên cần thiết và tiềm \nnăng.",
                    "Một trong những thách thức cơ bản mà ngành xây dựng đang phải đối mặt là việc \nquản lý tồn kho vật liệu.",
                    "Sự thiếu hụt hoặc lãng phí về tài nguyên có thể dẫn đến tổn thất \nvề thời gian và chi phí cho các dự án.",
                    "Các công ty xây dựng thường gặp khó khăn trong \nviệc theo dõi lượng tồn kho, dự đoán nhu cầu và quản lý các đơn hàng một cách hiệu \nquả.",
                    "Ngoài ra, việc quản lý các đơn đặt hàng cũng là một thách thức lớn đối với các \ndoanh nghiệp xây dựng.",
                    "Sự trễ hạn trong việc giao hàng có thể ảnh hưởng đến tiến độ \ncủa dự án và uy tín của công ty.",
                    "Việc không có một hệ thống quản lý đơn đặt hàng hiệu \nquả có thể dẫn đến việc thiếu hụt vật liệu hoặc gây ra sự trễ hạn trong việc giao hàng, \nảnh hưởng đến tiến độ của dự án và uy tín của công ty.",
                    "Để giải quyết những thách thức \nnày, dự án này tập trung vào việc xây dựng một ứng dụng quản lý vật liệu xây dựng trên \nnền tảng web.",
                    "Ứng dụng này sẽ giúp các doanh nghiệp xây dựng theo dõi và quản lý tồn \nkho vật liệu, tạo và quản lý các đơn đặt hàng một cách hiệu quả, từ đó tối ưu hóa quá \ntrình quản lý và giảm thiểu rủi ro và chi phí.",
                    "Trong phạm vi của dự án, tôi sẽ thực hiện \ncác nghiên cứu cẩn thận về các yếu tố ảnh hưởng đến quản lý vật liệu xây dựng, phát \ntriển và triển khai một ứng dụng web thân thiện người dùng và linh hoạt, cung cấp các \ntính năng quản lý vật liệu mạnh mẽ và đáng tin cậy.",
                    "Đồng thời, tôi cũng sẽ đề xuất các \ngiải pháp và chiến lược để tối ưu hóa quá trình quản lý vật liệu xây dựng, từ đó giúp các \ndoanh nghiệp xây dựng nâng cao hiệu quả và cạnh tranh trong thị trường xây dựng ngày \ncàng cạnh tranh.",
                    "1.2.",
                    "Lý do chọn đề tài: \n Trong bối cảnh sự phát triển nhanh chóng của ngành công nghiệp xây dựng, việc quản \nlý vật liệu xây dựng trở nên ngày càng phức tạp và đòi hỏi sự chính xác, hiệu quả cao.",
                    "Vật liệu xây dựng chiếm một tỷ trọng quan trọng trong mỗi dự án xây dựng, và việc \nquản lý chúng một cách thông minh có thể ảnh hưởng đến sự thành công của dự án, từ \nviệc đảm bảo nguồn cung đủ đến việc kiểm soát chi phí và thời gian.",
                    "Hiện nay, nhu cầu \nsử dụng vật liệu xây dựng đang tăng mạnh, đặc biệt là trong các dự án xây dựng lớn.",
                    "Điều này đặt ra thách thức lớn trong việc quản lý nguồn cung và chi phí vật liệu xây \ndựng, đặc biệt là khi giá trị của chúng có thể biến đổi thường xuyên dựa trên thị trường.",
                    "Sự phát triển của công nghệ thông tin mở ra nhiều cơ hội mới trong việc quản lý vật liệu \nxây dựng.",
                    "Tính linh hoạt và khả năng tích hợp của các hệ thống thông tin hiện đại có thể \ngiúp tối ưu hóa quy trình quản lý vật liệu, từ việc đặt hàng đến theo dõi và kiểm soát \nhàng tồn kho.",
                    "Việc quản lý vật liệu xây dựng không chỉ đơn giản là một phần của quá \ntrình xây dựng mà còn là yếu tố quyết định đến sự thành công của dự án.",
                    "Tầm quan \ntrọng của việc này không thể bỏ qua, và việc áp dụng công nghệ thông tin có thể giúp \ntối ưu hóa quy trình quản lý và đảm bảo hiệu suất cao hơn.",
                    "Quản lý vật liệu xây dựng \nhiệu quả không chỉ giúp tiết kiệm chi phí và thời gian mà còn đóng góp vào mục tiêu \nphát triển bền vững trong ngành xây dựng.",
                    "Việc giảm thiểu lãng phí và tối ưu hóa sử \ndụng tài nguyên có thể giảm thiểu tác động tiêu cực đến môi trường và xã hội.",
                    "9 \nTrong giáo dục, CNTT giúp tiếp cận tri thức một cách nhanh chóng và linh hoạt, tạo \nđiều kiện cho học tập từ xa và học tập suốt đời.",
                    "Một số lĩnh vực trong ngành CNTT bao gồm:  \n+ Phát triển phần mềm: Liên quan đến việc thiết kế, lập trình và duy trì các ứng dụng \nphần mềm phục vụ cho nhiều mục đích khác nhau, từ ứng dụng di động, trang web cho \nđến phần mềm quản lý doanh nghiệp."
                ],
